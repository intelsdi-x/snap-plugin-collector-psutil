...
func getVirtualMemoryMetricTypes() []plugin.MetricType {
	return []plugin.MetricType{
		...
		plugin.MetricType{
			Namespace_: core.NewNamespace([]string{"intel", "psutil", "vm", "available"}),
			Unit_:      "B",
		...
		plugin.MetricType{
			Namespace_: core.NewNamespace([]string{"intel", "psutil", "vm", "active"}),
			Description_: `(UNIX): memory currently in use or very recently used, 
			and so it is in RAM.`,
			Unit_: "B",
		},
		plugin.MetricType{
			Namespace_:   core.NewNamespace([]string{"intel", "psutil", "vm", "inactive"}),
			Description_: `(UNIX): memory that is marked as not used.`,
			Unit_:        "B",
		},
		plugin.MetricType{
			Namespace_:   core.NewNamespace([]string{"intel", "psutil", "vm", "buffers"}),
			Description_: `(Linux, BSD): cache for things like file system metadata.`,
			Unit_:        "B",
		},
		plugin.MetricType{
			Namespace_:   core.NewNamespace([]string{"intel", "psutil", "vm", "cached"}),
			Description_: `(Linux, BSD): cache for various things.`,
			Unit_:        "B",
		},
		plugin.MetricType{
			Namespace_: core.NewNamespace([]string{"intel", "psutil", "vm", "wired"}),
